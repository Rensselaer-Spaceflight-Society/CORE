...
**September 13 planning note:** the supplied DP-2 meeting cards use different gate dates/names and call September 17 a Wednesday; it is Thursday. Leads must reconcile those changes in the [decision log](../workspaces/coordination/decisions.md). Treat September 18 as a candidate/evidence review until the design inputs are substantiated. This published manufacturing timeline has not been silently replaced by the supplied cards.
